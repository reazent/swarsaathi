# Tabla samples — attribution

Recorded tabla bol strokes by **msarkar** on [Freesound](https://freesound.org/people/msarkar/packs/3571/).

| File | Sound | License |
|------|-------|---------|
| `dha.mp3` | [Dha.aif](https://freesound.org/people/msarkar/sounds/56144/) | Sampling+ |
...
Sampling+ allows use in transformed/combined works; retain this attribution in the app credits.
